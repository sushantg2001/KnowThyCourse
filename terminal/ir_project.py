...
Original file is located at
    https://colab.research.google.com/drive/1_50Bm9CtbF2vB9lybVRfyuWAte8Hk0EU
...
print(coursewise_to_search[0])
print(coursewise_to_search[1])
...
#   list_order = list(sorted_rating.keys())
#   super_ans[list(d.keys())[i]] = list_order
#   # if(len(rating)>=leftover):
#   #   for j in range(leftover):
#   #     ans.append(list_order[j])
#   #   break
#   # else:
...
# hitValue = list(d.keys())
# hitCount = []
# for id in hitValue:
#   hitCount.append( len(d[id]) )

# for id in range(len(hitValue)):
#   print("Hits: " + str(hitValue[id]) + "\tCourses: " + str(hitCount[id]))

# plt.xlabel("No of Hits")
# plt.ylabel("No of Courses")
# plt.title("No of Courses vs No of Hits")
# plt.plot(hitValue, hitCount)
# plt.show()
